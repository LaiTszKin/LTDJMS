...
- **ci/vercel**: 移除 GitHub Actions 的 Vercel landing page 自動部署 workflow，改由 Vercel Git 連動部署管理宣傳首頁發布
...
- **docs/vercel**: README 移除 GitHub Actions 控管 `VERCEL_*` 變數與 trusted-author 的部署說明，避免與 Vercel Git 連動部署流程混淆
