...
- `V002__migrate_dice_game_token_range_config.sql` - 遷移骰子遊戲代幣範圍配置
- `V003__remove_default_tokens_per_play.sql` - 移除預設代幣數量
- `V004__add_product_and_redemption_code.sql` - 新增產品與兌換碼表
- `V005__update_product_deletion_handle_redemption_codes.sql` - 更新產品刪除行為以處理兌換碼
- `V006__fix_product_id_nullable.sql` - 修正 product_id 可為 NULL
