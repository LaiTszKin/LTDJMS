...
/**
 * Unit tests for CommandLocalizations to verify zh-TW localization mappings
 * for all currency and game-related slash commands.
 */
class CommandLocalizationsTest {
    ...
    class CommandNameLocalizations {
        ...
        void shouldProvideZhTwLocalizationForBalanceCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getNameLocalizations("balance");
        ...
        void shouldProvideZhTwLocalizationForCurrencyConfigCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getNameLocalizations("currency-config");
        ...
        void shouldProvideZhTwLocalizationForAdjustBalanceCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getNameLocalizations("adjust-balance");
        ...
        void shouldProvideZhTwLocalizationForGameTokenAdjustCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getNameLocalizations("game-token-adjust");
        ...
        void shouldProvideZhTwLocalizationForUserPanelCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getNameLocalizations("user-panel");
        ...
        void shouldProvideZhTwLocalizationForAdminPanelCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getNameLocalizations("admin-panel");
        ...
        void shouldReturnEmptyMapForUnknownCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getNameLocalizations("unknown-command");
    ...
    class CommandDescriptionLocalizations {
        ...
        void shouldProvideZhTwDescriptionForBalanceCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getDescriptionLocalizations("balance");
        ...
        void shouldProvideZhTwDescriptionForCurrencyConfigCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getDescriptionLocalizations("currency-config");
        ...
        void shouldProvideZhTwDescriptionForAdjustBalanceCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getDescriptionLocalizations("adjust-balance");
        ...
        void shouldProvideZhTwDescriptionForGameTokenAdjustCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getDescriptionLocalizations("game-token-adjust");
        ...
        void shouldProvideZhTwDescriptionForUserPanelCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getDescriptionLocalizations("user-panel");
        ...
        void shouldProvideZhTwDescriptionForAdminPanelCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getDescriptionLocalizations("admin-panel");
        ...
        @DisplayName("should return empty map for unknown command")
        void shouldReturnEmptyMapForUnknownCommand() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getDescriptionLocalizations("unknown-command");
    ...
    class OptionLocalizations {
        ...
        void shouldProvideZhTwLocalizationForNameOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionNameLocalizations("name");
        ...
        void shouldProvideZhTwLocalizationForIconOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionNameLocalizations("icon");
        ...
        void shouldProvideZhTwLocalizationForModeOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionNameLocalizations("mode");
        ...
        void shouldProvideZhTwLocalizationForMemberOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionNameLocalizations("member");
        ...
        void shouldProvideZhTwLocalizationForAmountOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionNameLocalizations("amount");
        ...
        void shouldProvideZhTwLocalizationForTokenCostOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionNameLocalizations("token-cost");
    ...
    class OptionDescriptionLocalizations {
        ...
        void shouldProvideZhTwDescriptionForNameOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionDescriptionLocalizations("name");
        ...
        void shouldProvideZhTwDescriptionForIconOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionDescriptionLocalizations("icon");
        ...
        void shouldProvideZhTwDescriptionForModeOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionDescriptionLocalizations("mode");
        ...
        void shouldProvideZhTwDescriptionForMemberOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionDescriptionLocalizations("member");
        ...
        void shouldProvideZhTwDescriptionForAmountOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionDescriptionLocalizations("amount");
        ...
        void shouldProvideZhTwDescriptionForTokenCostOption() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getOptionDescriptionLocalizations("token-cost");
    ...
    class ChoiceLocalizations {
        ...
        void shouldProvideZhTwLocalizationForDeductChoice() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getChoiceLocalizations("deduct");
        ...
        void shouldProvideZhTwLocalizationForAdjustChoice() {
            Map<DiscordLocale, String> localizations = CommandLocalizations.getChoiceLocalizations("adjust");
