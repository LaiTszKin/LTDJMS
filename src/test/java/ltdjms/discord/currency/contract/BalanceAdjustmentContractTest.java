...
/**
 * Contract tests for balance adjustment operations.
 * Verifies that adjustment responses conform to the OpenAPI contract.
 */
class BalanceAdjustmentContractTest {
    ...
    void accountShouldRejectNegativeBalance() {
        assertThatThrownBy(() -> new MemberCurrencyAccount(
                TEST_GUILD_ID, TEST_USER_ID, -100L,
    ...
    void adjustmentResultShouldFormatMessageCorrectly() {
        ...
        BalanceAdjustmentResult creditResult = new BalanceAdjustmentResult(
                TEST_GUILD_ID, TEST_USER_ID,
                100L, 150L, 50L, "Gold", "💰"
        );
        ...
        BalanceAdjustmentResult debitResult = new BalanceAdjustmentResult(
                TEST_GUILD_ID, TEST_USER_ID,
                150L, 100L, -50L, "Gold", "💰"
        );
