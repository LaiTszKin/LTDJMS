...
/**
 * Integration tests for bot restart and reconnection scenarios.
...
class BotRestartIntegrationTest extends PostgresIntegrationTestBase {
    ...
    class AtomicOperationTests {
        ...
        @Test
        @DisplayName("should maintain balance consistency when balance view and adjustment interleaved with restart")
        void shouldMaintainConsistencyWhenInterleavedWithRestart() {
            ...
            // Final check
            assertThat(newBalanceService.getBalance(TEST_GUILD_ID, TEST_USER_ID).balance()).isEqualTo(500L);
        }
    }
