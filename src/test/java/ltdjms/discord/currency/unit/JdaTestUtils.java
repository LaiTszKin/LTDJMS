...
public final class JdaTestUtils {
    ...
    /**
     * Captures the reply message from a mock event.
     * Call this after the handler has processed the event.
     *
    ...
    public static class ReplyCaptor {
        ...
        public void verifyReplyContains(String substring) {
            ...
            if (!actual.contains(substring)) {
                throw new AssertionError("Expected reply to contain '" + substring + "' but was '" + actual + "'");
            }
        }
