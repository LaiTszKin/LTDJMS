...
/**
 * Unit tests for BalanceCommandHandler response formatting.
 * Tests the formatting logic without mocking JDA events (due to Java 25 restrictions).
 * The actual command handler integration is tested via integration tests.
 */
class BalanceCommandHandlerTest {
    ...
    void shouldFormatBalanceDisplayCorrectly() {
        ...
        BalanceView balanceView = new BalanceView(
                TEST_GUILD_ID, TEST_USER_ID, 500L, "Gold", "💰");
    ...
    void shouldFormatBalanceMessageCorrectly() {
        // Given
        BalanceView balanceView = new BalanceView(
                TEST_GUILD_ID, TEST_USER_ID, 100L, "Diamonds", "💎");
    ...
    void shouldFormatZeroBalanceCorrectly() {
        // Given
        BalanceView balanceView = new BalanceView(
                TEST_GUILD_ID, TEST_USER_ID, 0L, "Coins", "🪙");
    ...
    void shouldFormatLargeBalanceWithCommaSeparators() {
        // Given
        BalanceView balanceView = new BalanceView(
                TEST_GUILD_ID, TEST_USER_ID, 1234567L, "Gold", "💰");
    ...
    void shouldIncludeAllRequiredFields() {
        // Given
        BalanceView balanceView = new BalanceView(
                TEST_GUILD_ID, TEST_USER_ID, 42L, "Stars", "⭐");
    ...
    void shouldFormatEmojiIconsCorrectly() {
        ...
        BalanceView balanceView = new BalanceView(
                TEST_GUILD_ID, TEST_USER_ID, 100L, "Trophies", "🏆");
