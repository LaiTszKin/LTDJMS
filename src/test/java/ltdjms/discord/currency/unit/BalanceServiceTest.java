...
class BalanceServiceTest {
    ...
    void shouldReturnExistingBalanceForExistingMember() {
        ...
        MemberCurrencyAccount existingAccount = new MemberCurrencyAccount(
                TEST_GUILD_ID, TEST_USER_ID, 500L, now, now);
    ...
    void shouldUseCustomCurrencyConfigWhenExists() {
        ...
        MemberCurrencyAccount account = MemberCurrencyAccount.createNew(TEST_GUILD_ID, TEST_USER_ID);
        Instant now = Instant.now();
        GuildCurrencyConfig customConfig = new GuildCurrencyConfig(
    ...
    void shouldIsolateBalancesBetweenGuilds() {
        ...
        Instant now = Instant.now();
        MemberCurrencyAccount account1 = new MemberCurrencyAccount(guild1, TEST_USER_ID, 100L, now, now);
        MemberCurrencyAccount account2 = new MemberCurrencyAccount(guild2, TEST_USER_ID, 200L, now, now);
