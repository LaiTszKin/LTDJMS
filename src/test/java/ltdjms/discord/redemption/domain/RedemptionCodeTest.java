...
class RedemptionCodeTest {
    ...
    class RedemptionCodeCreationTests {
        ...
        void shouldCreateCodeWithExpiration() {
            ...
            // When
            RedemptionCode code = RedemptionCode.create(
                    "ABCD1234EFGH5678", TEST_PRODUCT_ID, TEST_GUILD_ID, expiresAt);
        ...
        void shouldRejectNullCode() {
            assertThatThrownBy(() ->
                    RedemptionCode.create(null, TEST_PRODUCT_ID, TEST_GUILD_ID, null))
        ...
        void shouldRejectBlankCode() {
            assertThatThrownBy(() ->
                    RedemptionCode.create("   ", TEST_PRODUCT_ID, TEST_GUILD_ID, null))
    ...
    class ExpirationChecksTests {
        ...
        void shouldDetectExpiredCode() {
            ...
            RedemptionCode code = RedemptionCode.create(
                    "ABCD1234EFGH5678", TEST_PRODUCT_ID, TEST_GUILD_ID, pastDate);
        ...
        void shouldDetectNonExpiredCode() {
            ...
            RedemptionCode code = RedemptionCode.create(
                    "ABCD1234EFGH5678", TEST_PRODUCT_ID, TEST_GUILD_ID, futureDate);
