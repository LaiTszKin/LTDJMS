...
/**
 * Unit tests for GameTokenAdjustCommandHandler response formatting.
...
class GameTokenAdjustCommandHandlerTest {
    ...
    void shouldFormatTokenAdjustmentMessageForAddition() {
        ...
        TokenAdjustmentResult result = new TokenAdjustmentResult(
                TEST_GUILD_ID, TEST_USER_ID, 100L, 150L, 50L);
    ...
    void shouldFormatTokenAdjustmentMessageForRemoval() {
        // Given
        TokenAdjustmentResult result = new TokenAdjustmentResult(
                TEST_GUILD_ID, TEST_USER_ID, 100L, 50L, -50L);
    ...
    void shouldFormatLargeTokenAmountsWithCommaSeparators() {
        // Given
        TokenAdjustmentResult result = new TokenAdjustmentResult(
                TEST_GUILD_ID, TEST_USER_ID, 0L, 1234567L, 1234567L);
    ...
    void shouldHandleZeroPreviousTokensCorrectly() {
        // Given
        TokenAdjustmentResult result = new TokenAdjustmentResult(
                TEST_GUILD_ID, TEST_USER_ID, 0L, 100L, 100L);
