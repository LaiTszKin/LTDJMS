...
class GameTokenServiceCacheTest {
    ...
    class CacheMissTests {
        ...
        void shouldQueryDatabaseAndPopulateCacheOnMiss() {
            // Given
            GameTokenAccount account = GameTokenAccount.createNew(GUILD_ID, USER_ID).withAdjustedTokens(TOKENS);
    ...
    class TokenAdjustmentCacheUpdateTests {
        ...
        void shouldUpdateCacheAfterSuccessfulAdjustment() {
            ...
            GameTokenAccount current = GameTokenAccount.createNew(GUILD_ID, USER_ID).withAdjustedTokens(TOKENS);
            GameTokenAccount updated = GameTokenAccount.createNew(GUILD_ID, USER_ID).withAdjustedTokens( newTokens);
            ...
            // When
            GameTokenService.TokenAdjustmentResult result = service.adjustTokens(GUILD_ID, USER_ID, adjustment);
