...
/**
 * Unit tests for UserPanelEmbedBuilder.
 * Verifies consistent embed and component building for user panel display.
 */
class UserPanelEmbedBuilderTest {
    ...
    void buildPanelComponentsShouldReturnTwoActionRows() {
        ...
        // When
        List<ActionRow> components = UserPanelEmbedBuilder.buildPanelComponents(
                "btn_currency",
                "btn_token",
                "btn_product",
                "btn_redeem",
