...
/**
 * JDBC-based implementation of GameTokenTransactionRepository.
 * Provides methods to save and query game token transaction history.
 */
public class JdbcGameTokenTransactionRepository implements GameTokenTransactionRepository {

    private static final Logger LOG = LoggerFactory.getLogger(JdbcGameTokenTransactionRepository.class);
    ...
    public GameTokenTransaction save(GameTokenTransaction transaction) {
        String sql = "INSERT INTO game_token_transaction " +
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    GameTokenTransaction saved = new GameTokenTransaction(
                            id,
                            transaction.guildId(),
                            transaction.userId(),
                            transaction.amount(),
                    ...
                    LOG.debug("Saved game token transaction: id={}, guildId={}, userId={}, amount={}, source={}",
            ...
            LOG.error("Failed to save game token transaction for guildId={}, userId={}",
    ...
    @Override
    public List<GameTokenTransaction> findByGuildIdAndUserId(long guildId, long userId, int limit, int offset) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            LOG.debug("Found {} transactions for guildId={}, userId={} (limit={}, offset={})",
