...
/**
 * Provides zh-TW localization mappings for all slash commands, options, and choices.
 * This class centralizes all localization definitions to ensure consistency across
 * command registration and provides easy maintenance of translations.
 *
 * <p>The English canonical names remain unchanged to maintain backwards compatibility
 * with existing specs and documentation. Localization is applied through Discord's
 * built-in localization API, allowing zh-TW clients to see Chinese names while
 * other clients see the English defaults.</p>
 */
public final class CommandLocalizations {
    ...
    static {
        ...
        COMMAND_DESCRIPTION_LOCALIZATIONS.put("balance",
                Map.of(DiscordLocale.CHINESE_TAIWAN, "查看您目前的貨幣餘額"));
        COMMAND_DESCRIPTION_LOCALIZATIONS.put("currency-config",
                Map.of(DiscordLocale.CHINESE_TAIWAN, "設定伺服器的貨幣名稱與圖示"));
        COMMAND_DESCRIPTION_LOCALIZATIONS.put("adjust-balance",
                Map.of(DiscordLocale.CHINESE_TAIWAN, "調整成員的貨幣餘額"));
        ...
        OPTION_DESCRIPTION_LOCALIZATIONS.put("name",
                Map.of(DiscordLocale.CHINESE_TAIWAN, "貨幣名稱（例如：金幣）"));
        OPTION_DESCRIPTION_LOCALIZATIONS.put("icon",
                Map.of(DiscordLocale.CHINESE_TAIWAN, "貨幣圖示/表情符號（例如：💰）"));
        OPTION_DESCRIPTION_LOCALIZATIONS.put("mode",
                Map.of(DiscordLocale.CHINESE_TAIWAN, "調整模式"));
        OPTION_DESCRIPTION_LOCALIZATIONS.put("member",
                Map.of(DiscordLocale.CHINESE_TAIWAN, "要調整的成員"));
        OPTION_DESCRIPTION_LOCALIZATIONS.put("amount",
