...
/**
 * JDBC-based implementation of GuildCurrencyConfigRepository.
...
public class JdbcGuildCurrencyConfigRepository implements GuildCurrencyConfigRepository {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(JdbcGuildCurrencyConfigRepository.class);
    ...
    public Optional<GuildCurrencyConfig> findByGuildId(long guildId) {
        String sql = "SELECT guild_id, currency_name, currency_icon, created_at, updated_at " +
    ...
    public GuildCurrencyConfig save(GuildCurrencyConfig config) {
        String sql = "INSERT INTO guild_currency_config (guild_id, currency_name, currency_icon, created_at, updated_at) " +
                "VALUES (?, ?, ?, ?, ?)";
    ...
    public GuildCurrencyConfig update(GuildCurrencyConfig config) {
        String sql = "UPDATE guild_currency_config SET currency_name = ?, currency_icon = ?, updated_at = ? " +
                "WHERE guild_id = ?";
