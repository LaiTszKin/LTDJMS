...
/**
 * JDBC-based implementation of MemberCurrencyAccountRepository.
...
public class JdbcMemberCurrencyAccountRepository implements MemberCurrencyAccountRepository {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(JdbcMemberCurrencyAccountRepository.class);
    ...
    public Optional<MemberCurrencyAccount> findByGuildIdAndUserId(long guildId, long userId) {
        String sql = "SELECT guild_id, user_id, balance, created_at, updated_at " +
    ...
    public MemberCurrencyAccount save(MemberCurrencyAccount account) {
        String sql = "INSERT INTO member_currency_account (guild_id, user_id, balance, created_at, updated_at) " +
                "VALUES (?, ?, ?, ?, ?)";
