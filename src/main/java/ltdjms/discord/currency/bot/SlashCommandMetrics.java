...
/**
 * Collects and reports metrics for slash command execution.
 * Tracks latency (p50, p95, p99), success/error counts, and throughput.
 */
public class SlashCommandMetrics {
    ...
    public void recordEnd(ExecutionContext context, boolean succeeded) {
        ...
        CommandMetrics metrics = commandMetrics.computeIfAbsent(
                context.commandName(), k -> new CommandMetrics());
        ...
        LOG.debug("Command {} completed in {}ms, success={}",
                context.commandName(), latencyMs, succeeded);
    }
    ...
    public AggregatedMetrics getAggregatedMetrics() {
        ...
        long[] allLatencies = commandMetrics.values().stream()
    ...
    public void logMetricsSummary() {
        ...
        commandMetrics.forEach((name, metrics) -> {
            MetricsSummary summary = metrics.getSummary(name);
            LOG.info("Command [{}]: total={}, success={}, errors={}, p50={}ms, p95={}ms, p99={}ms",
                    summary.commandName(),
                    summary.totalCount(),
        ...
        LOG.info("Aggregated: total={}, errors={}, errorRate={:.2f}%, p95={}ms",
    ...
    public record AggregatedMetrics(
        ...
        /**
         * Checks if the metrics meet SC-001 criteria.
         * - p95 latency <= 1000ms
         * - error rate < 1%
         */
