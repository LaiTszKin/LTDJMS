...
public interface RedemptionCodeRepository {
  ...
  /**
   * Invalidates all redemption codes for a product. This is called when a product is being deleted.
   *
   * @param productId the product ID
  ...
  record CodeStats(long totalCount, long redeemedCount, long unusedCount, long expiredCount) {
    public CodeStats {
